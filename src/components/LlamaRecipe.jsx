const LlamaRecipe = () => {
  return (
    <section className="flex flex-col gap-4 py-10 max-w-[500px]">
      <h2 className="text-3xl font-semibold">Chef Claude Recommends:</h2>
      <article className="flex flex-col gap-4" aria-live="polite">
        ...
        <h3 className="text-2xl font-semibold">Beef Bolognese Pasta</h3>
